 ...
 */
public class Test2Invoker implements Invoker<String, String, Integer, Long, Throwable> {
    ...
    public Long invoke(Integer internalRequest) throws Throwable {
        return new Long(internalRequest + 2);
    }
    ...
    public Long onFailure(String request, Throwable t) throws Throwable {
        ...
        return new Long(NumberUtils.parseNumber(request, Long.class) + 2);
    }
