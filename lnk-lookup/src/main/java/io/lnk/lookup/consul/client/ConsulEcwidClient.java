package io.lnk.lookup.consul.client;
...
import io.lnk.lookup.consul.ConsulResponse;
import io.lnk.lookup.consul.ConsulService;
...
public class ConsulEcwidClient extends LnkConsulClient {
	protected static final Logger log = LoggerFactory.getLogger(ConsulEcwidClient.class);
