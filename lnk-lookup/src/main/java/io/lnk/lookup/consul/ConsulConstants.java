...
public class ConsulConstants {
	 ...
	 */
	public static final String CONSUL_SERVICE_LNK_PRE = "lnkrpc_";

	/**
	 * motan协议在consul tag中的前缀
	 */
	public static final String CONSUL_TAG_LNK_PROTOCOL = "protocol_";
	
	public static final String CONSUL_TAG_LNK_VERSION = "version_";

	public static final String CONSUL_TAG_LNK_URL = "URL_";

	/**
	 * motan rpc 在consul中存储command的目录
	 */
	public static final String CONSUL_LNK_COMMAND = "lnk/command/";
