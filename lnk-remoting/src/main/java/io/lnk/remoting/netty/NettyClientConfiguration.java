 ...
 */
public class NettyClientConfiguration implements Cloneable, SystemConfiguration {
    ...
    @Override
    protected NettyClientConfiguration clone() throws CloneNotSupportedException {
        return (NettyClientConfiguration) super.clone();
    }
}
